...
% ---------------------------------------------------------------------- %
function [DeepMIMO_dataset,params]=DeepMIMO_generator(params,deepmimo_root_path)

% -------------------------- DeepMIMO Dataset Generation -----------------%
fprintf(' DeepMIMO Dataset Generation started \n')
% Read scenario parameters
load(strcat(deepmimo_root_path,'/RayTracing Scenarios/',params.scenario,'/',params.scenario,'.params.mat'))
...
for t=1:1:params.num_BS
    if sum(t == params.active_BS) ==1
        filename_DoD=strcat(deepmimo_root_path,'/RayTracing Scenarios/',params.scenario,'/',params.scenario,'.',int2str(t),'.DoD.mat');
        filename_CIR=strcat(deepmimo_root_path,'/RayTracing Scenarios/',params.scenario,'/',params.scenario,'.',int2str(t),'.CIR.mat');
        filename_Loc=strcat(deepmimo_root_path,'/RayTracing Scenarios/',params.scenario,'/',params.scenario,'.Loc.mat');
...
if params.saveDataset==1
    sfile_DeepMIMO=strcat(deepmimo_root_path,'/DeepMIMO Dataset/DeepMIMO_dataset.mat');
